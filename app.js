// API Configuration
const API_BASE = "https://portifolio-yohl.onrender.com";
    ...
    detailContent.innerHTML = `
        ...
        <div class="upload-form">
            ...
            <div class="form-group">
                ...
                <p style="color: var(--gray-500);">${formatExactDate(getDisplayDate(project))}</p>
            </div>
        </div>
    `;
...
function renderProjects(projects) {
    ...
    projects.forEach((project) => {
        ...
        date.innerHTML = `<i class="fa-regular fa-calendar-alt"></i> ${formatExactDate(getDisplayDate(project))}`;
